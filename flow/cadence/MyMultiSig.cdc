...
pub contract MyMultiSig {
    ...
    pub resource Manager: ManagerPublic {
        ...
        pub fun signerApproveAction(actionUUID: UInt64, messageSignaturePayload: MessageSignaturePayload) {
            ...
            // Validate Message
            assert(
                MyMultiSig.approveOrRejectActionMessageIsValid(action: action, messageSignaturePayload: messageSignaturePayload),
        ...
        pub fun signerRejectAction(actionUUID: UInt64, messageSignaturePayload: MessageSignaturePayload) {
            ...
            // Validate Message
            assert(
                MyMultiSig.approveOrRejectActionMessageIsValid(action: self.borrowAction(actionUUID: actionUUID), messageSignaturePayload: messageSignaturePayload),
                message: "Signed message is invalid"
            )
