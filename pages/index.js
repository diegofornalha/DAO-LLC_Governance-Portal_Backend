...
export default function Home() {
  ...
  return (
    <div className='bg-[#011E30] flex flex-col min-h-screen'>
      <Head>
        <title>DAO LLC - Governance Portal</title>
        <meta name="description" content="DApp for Managing ExampleToken's Finest DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className='container mx-auto flex-1 p-5'>
        <div className='mb-5 flex justify-between items-center pr-10 pt-2'>
          <h1 className={styles.sooth}>DAO LLC - Governance Portal</h1>
      ...
      <footer>
        ...
        <div className='bg-black flex pt-10 pb-5 justify-center items-center text-white'>
          <div className='w-[80%] flex justify-between items-center'>
            <div className='font-jet text-xs'>2022. All rights reserved - Eureka DAO Software LLC.</div>
          </div>
        </div>
      </footer>
    </div>
